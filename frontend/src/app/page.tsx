...
import { FileImage, FileText, Infinity, Lock, RefreshCw, Ruler, Shrink, Smartphone, Zap } from "lucide-react";
...
export default function Home() {
  ...
  const featuredTools = [
    {
      ...
      description: "Convert JPG, PNG, WebP, and AVIF formats in seconds, directly in your browser.",
      badge: "Most searched",
    ...
    },
    {
      ...
      description: "Compress JPG, PNG, and WebP images online without noticeable quality loss.",
      badge: "No upload",
    ...
    },
    {
      ...
      description: "Resize photos by width and height for websites, forms, and social media posts.",
      badge: "Editor",
    ...
    },
    {
      ...
      description: "Convert multiple JPG, PNG, or WebP files into a single PDF online.",
      badge: "PDF",
    ...
    {
      title: "HEIC to PNG",
      description: "Convert iPhone HEIC/HEIF photos to PNG instantly with private on-device processing.",
      badge: "iPhone",
      meta: "HEIC/HEIF to PNG",
      icon: "heicPng" as const,
      href: "/heic-to-png",
    },
    {
      title: "Resize Image to 200KB",
      description: "Resize and compress images to a 200KB target for forms and quick uploads.",
      badge: "Target size",
  ...
  const howItWorksSteps = [
    {
      step: "01",
      title: "Choose a tool",
      description: "Pick a converter, compressor, or PDF tool based on what you need.",
      detail: "No account required",
    },
    {
      step: "02",
      title: "Add your images",
      description: "Drop files in, adjust options if needed, and preview before processing.",
      detail: "Works on desktop and mobile",
    },
    {
      step: "03",
      title: "Download instantly",
      description: "Get the converted or optimized file right away, fully on your device.",
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 pb-10 pt-10 sm:px-6 lg:px-8">
      ...
      <section className="mt-7 rounded-[20px] border border-[#d4cfc4] bg-white p-5 sm:p-6" style={{ contentVisibility: "auto", containIntrinsicSize: "760px" }}>
        <div className="mb-4 flex items-end justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.09em] text-[#6b6760]">Featured</p>
            <h2 className="mt-1 text-xl font-extrabold tracking-[-0.03em]">Start with the most-used tools</h2>
          </div>
          <Link
            href="/image-converter"
            prefetch
          ...
          {featuredTools.map((tool) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-2 min-h-[58px] text-xs leading-5 text-[#6b6760]">{tool.description}</p>
      ...
      <section className="mt-7 overflow-hidden rounded-[20px] border border-[#d4cfc4] bg-[#fff7f2] p-5 sm:p-6" style={{ contentVisibility: "auto", containIntrinsicSize: "540px" }}>
        <div className="mb-5 flex items-end justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.09em] text-[#8b5a42]">How it works</p>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
          {howItWorksSteps.map((item) => (
            <div key={item.step} className="rounded-2xl border border-[#edcfbe] bg-white p-4">
              ...
              <p className="mt-3 text-[11px] font-semibold uppercase tracking-[0.08em] text-[#9a7f6d]">{item.detail}</p>
            </div>
          ))}
        </div>
      ...
      <section className="mt-7 rounded-[20px] bg-[#1c1a14] p-6 text-[#f7f3ec] sm:p-8" style={{ contentVisibility: "auto", containIntrinsicSize: "320px" }}>
        <div className="grid grid-cols-2 gap-x-4 gap-y-6 sm:grid-cols-4 sm:gap-x-6">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-1 text-xs uppercase tracking-[0.08em] text-[#f7f3ec]/55">Available</div>
          </div>
        </div>
      </section>
